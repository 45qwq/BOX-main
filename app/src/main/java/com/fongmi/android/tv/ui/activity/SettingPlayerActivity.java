...
public class SettingPlayerActivity extends BaseActivity implements UaCallback, BufferCallback, SpeedCallback {
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        mBinding.autoRotateSwitch.setChecked(Setting.isAutoRotate());
    ...
    protected void initEvent() {
        ...
        mBinding.autoRotateSwitch.setOnClickListener(this::setAutoRotate);
    ...
    private void setAutoRotate(View view) {
        boolean isChecked = !Setting.isAutoRotate();
        Setting.putAutoRotate(isChecked);
    }
