...
public abstract class HistoryDao extends BaseDao<History> {
    ...
    @Query("SELECT * FROM History")
    public abstract LiveData<List<History>> findAllLive();
    ...
    @Query("SELECT * FROM History WHERE cid = :cid AND createTime >= :createTime ORDER BY createTime DESC")
    public abstract LiveData<List<History>> findLive(int cid, long createTime);
    ...
    @Query("SELECT * FROM History WHERE createTime >= :createTime ORDER BY createTime DESC")
    public abstract LiveData<List<History>> findAllRecentLive(long createTime);
