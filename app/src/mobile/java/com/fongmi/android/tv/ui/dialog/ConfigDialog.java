...
public class ConfigDialog {
    ...
    private void onPositive(DialogInterface dialog, int which) {
        ...
        App.execute(() -> {
            ...
            android.util.Log.d("ConfigDialog", "Calling Config.find with url=" + finalUrl + ", type=" + finalType);
    ...
    private void checkConfigLoad(String url, String originalUrl, int type) {
        android.util.Log.d("ConfigDialog", "Delayed check: verifying config load");
        Config currentConfig = getConfig();
        if (currentConfig == null || !currentConfig.getUrl().equals(url)) {
            android.util.Log.d("ConfigDialog", "Config load failed, restoring original URL");
